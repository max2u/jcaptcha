 ...
 * Can accept and serve any captcha type.
 * <br> beware of class cast exception if you call the wrong typed getChallenge method!
 *
...
public class GenericManageableCaptchaService extends AbstractManageableCaptchaService implements MultiTypeCaptchaService
{
     ...
     * Constructor
     *
     * @param captchaEngine       the used engine. Use the
     *                            {@link com.octo.captcha.engine.bufferedengine.BufferedEngineContainer} to enable buffered captcha generation
